  ...
  return (
    <div id="products" className="py-8">
      <div className="container">
        ...
        <p className="text-[24px] sm:text-[32px] font-bold text-center py-8 leading-[1.2]">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16  ">
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-center mt-4 text-[18px] sm:text-[22px] font-medium leading-[1.2]">
        ...
        <div className="mt-8 md:mt-16 grid md:grid-cols-2 gap-8 md:gap-16">
          ...
          <div className="text-center md:text-right  text-[22px] font-medium leading-[1.2]">
