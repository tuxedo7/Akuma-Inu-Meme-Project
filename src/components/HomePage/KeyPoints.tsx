      ...
      <div className="container z-10 relative">
        <div className=" ">
          ...
          <div className="relative z-20  mt-4 md:mt-0">
            ...
            <ul className="text-[18px] md:text-[24px] leading-[1.4] max-w-[496px] mx-auto md:mx-[unset] text-left md:text-justify -tracking-[.05em] list-inside md:list-outside  flex flex-col gap-5 font-medium pl-2 sm:pl-8 pt-7 md:pt-9 list-disc">
